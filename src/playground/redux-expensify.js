...
const getVisibleExpenses = (expenses, {text, sortBy, startDate, endDate}) => {
  return expenses.filter((expense) => {
    ...
    const endDateMatch = typeof endDatre !== 'number' || expense.createdAt <= endDate;
...
store.subscribe(() => {
  ...
  console.log(svisableExpenses)
})

const expenseOne = store.dispatch(addExpense({description: 'Rent', amount: 100,createdAt: 1000}));
const expenseTwo = store.dispatch(addExpense({description: 'Caffe', amount: 300,createdAt: -1000}));
